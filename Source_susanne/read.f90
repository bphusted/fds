...
USE SCRC, ONLY: SCARC_METHOD, SCARC_DISCRETIZATION, SCARC_STORAGE, SCARC_STENCIL, SCARC_ERROR_FILE, SCARC_ACCURACY, &
...
NAMELIST /PRES/ CHECK_POISSON,FISHPAK_BC,ITERATION_SUSPEND_FACTOR,LAPLACE_PRESSURE_CORRECTION, &
                SCARC_METHOD, SCARC_DISCRETIZATION, SCARC_STORAGE, SCARC_STENCIL, SCARC_ERROR_FILE, SCARC_ACCURACY, &
                SCARC_KRYLOV, SCARC_KRYLOV_ITERATIONS, SCARC_KRYLOV_ACCURACY, SCARC_KRYLOV_INTERPOL, &
                SCARC_MULTIGRID, SCARC_MULTIGRID_ITERATIONS, SCARC_MULTIGRID_ACCURACY, SCARC_PRECISION, SCARC_TWOLEVEL, &
                SCARC_MULTIGRID_CYCLE, SCARC_MULTIGRID_LEVEL, SCARC_MULTIGRID_COARSENING, SCARC_MULTIGRID_INTERPOL, &
                SCARC_SMOOTH, SCARC_SMOOTH_SCOPE, SCARC_SMOOTH_ITERATIONS, SCARC_SMOOTH_ACCURACY, SCARC_SMOOTH_OMEGA, &
