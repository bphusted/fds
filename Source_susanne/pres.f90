...
USE SCRC, ONLY: SCARC_DUMP, SCARC_DUMP_ENVIRONMENT

INTEGER, INTENT(IN) :: NM
REAL(EB), INTENT(IN) :: T
REAL(EB), POINTER, DIMENSION(:,:,:) :: UU,VV,WW,HP,RHOP,P,RESIDUAL
INTEGER :: I,J,K,IW,IOR,NOM,N_INT_CELLS,IIO,JJO,KKO !,IERR
...
!WRITE(*,*) 'PRES: SAVE1'
!WRITE(*,'(5E16.6)') SAVE1
!WRITE(*,*) 'PRES: ITRN=', ITRN
!WRITE(*,*) 'PRES: POIS_PTB=', POIS_PTB
!WRITE(*,*) 'PRES: PRHS'
!DO K=KBAR, 1, -1
!   WRITE(*,'(6E16.6)') (PRHS(I,1,K), I=1,IBAR)
!ENDDO

IF (SCARC_DUMP) THEN
   CALL SCARC_DUMP_ENVIRONMENT
   SCARC_DUMP = .FALSE.
ENDIF
...
!WRITE(*,*) 'PRES: HP:'
!DO K = KBAR, 1, -1
!   WRITE(*,'(6E16.6)') (HP(I, 1, K), I=1, IBAR)
!ENDDO
